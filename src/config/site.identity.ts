export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'bharatamayu',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Bharat Amayu',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'bharatamayu.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://bharatamayu.com',

      ...
      <main className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <section className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-stretch">
          ...
          <div className="rounded-[2rem] border border-[#2C5D63]/18 bg-white p-8 shadow-[0_18px_40px_rgba(40,55,57,0.06)]">
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-[#2C5D63]/70">Create account</p>
            <form className="mt-6 grid gap-4">
              <input className="h-12 rounded-xl border border-[#2C5D63]/18 bg-white px-4 text-sm" placeholder="Full name" />
              <input className="h-12 rounded-xl border border-[#2C5D63]/18 bg-white px-4 text-sm" placeholder="Email address" />
              <input className="h-12 rounded-xl border border-[#2C5D63]/18 bg-white px-4 text-sm" placeholder="Password" type="password" />
              <input className="h-12 rounded-xl border border-[#2C5D63]/18 bg-white px-4 text-sm" placeholder="What are you creating or publishing?" />
              <button type="submit" className="inline-flex h-12 items-center justify-center rounded-full bg-[#A2C11C] px-6 text-sm font-semibold text-[#283739] hover:bg-[#b4cf3a]">Create account</button>
            </form>
